 ...
 * to fetch" or its platform's equivalent, and collapses to another (#66).
 * Everything else keeps the server's own message, which is usually the
 * actionable part (an RLS denial, an expired JWT, a constraint).
 *
